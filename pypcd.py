...
__all__ = ['PointCloud',
           ...
           'make_xyz_intensity_point_cloud',
           'save_txt',
           'cat_point_clouds',
           'add_fields',
           'update_field',
...
def point_cloud_to_fileobj(pc, fileobj, data_compression=None):
    ...
    header = write_header(metadata).encode()
...
def make_xyz_intensity_point_cloud(xyzi, label_type='f'):
...
def get_points_xyz(pc_data, dtype=np.float32):
